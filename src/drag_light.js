...
/*
    ...
    В отличие от полноценного dragdrop, отсюда убраны:
    * drop - полностью, и все что с ним связано (в т.ч. dragover)
    * scroll контейнера при таскании
    * убирание pointer events у object'ов на время таскания
    * false может возвращать только draginit (убрано dead и nAlive)
 */
(function( $ ) {
    var drag_defaults = {
